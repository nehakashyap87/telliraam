...
(function ($) {
	...
	-----------------------------------------------------*/
		var Ecommerce = {
			...
			e_new_banner: function () {
				if ($('.e-new-banner-wrapper .new-swipe-container').length > 0) {
					let ebannerSliderr;
					...
					function initBannerSwiper() {
						...
						if (isSmallScreen) {
							if (ebannerSliderr) {
								ebannerSliderr.destroy(true, true);
								ebannerSliderr = null;
							}
						} else {
						
							if (!ebannerSliderr) {
								ebannerSliderr = new Swiper('.e-new-banner-wrapper .new-swipe-container', {
									direction: 'vertical',
									loop: false,
									pagination: {
										el: '.swiper-pagination',
					...
					initBannerSwiper();
					$(window).on('resize', initBannerSwiper);
				}
			},
			...
			offer_counter: function () {
				if($('#countdown').length > 0){
					(function () {
						...
						let offer = "july 20, 2025 11:53:00",
			...
			product_remove: function () {
			 ...
			 clientslider: function () {
				var swiper = new Swiper(".clientslider", {
				  ...
				  autoplay: true,
				  navigation: {
					nextEl: '.fl-client-wrapper .swiper-button-next',
					prevEl: '.fl-client-wrapper .swiper-button-prev',
				},
