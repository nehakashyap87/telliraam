...
//     { img: "/images/03.png", text: "Vegetables" },
//     { img: "/images/04.png", text: "Banana" },
//     { img: "/images/05.png", text: "Fruits" },
//     { img: "/images/06.png", text: "Carrot" },
//     { img: "/images/07.png", text: "Cabbage" }, // fixed path
//     { img: "/images/08.png", text: "Cucumber" },
//     { img: "/images/09.png", text: "Carrot" },
//     { img: "/images/10.png", text: "Dry Foods" },
//     { img: "/images/11.png", text: "Chili/Pepper" },
//   ];
//   const banners = [
//     {
//       id: 1,
...
//                     <div className="swiper-container new-swipe-container">
//                         <div className="swiper-wrapper">
//                             <div className="swiper-slide swiper-slide-one">
//                                 <div className="row align-items-center">
//                                     <div className="col-lg-6">
//                                         <div className="e-new-banner-heading">
//                                             <h1 className="e-banner-three-title">Your Go-To Place for Quality and Affordable Prices</h1>
//                                             <p>At Grocery Store, we bring you the finest selection of fresh produce, pantry essentials, and everyday favorites.</p>
...
//                                        <img src="/images/new-bnr-third.png" alt=""/>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                     <div className="col-lg-6">
//                                         <div className="e-new-banner-heading">
//                                             <h3>Trustworthy Freshness, Every Single Day!</h3>
//                                             <h1 className="e-banner-three-title">Where Quality Meets Savings, Right in Your Neighborhood</h1>
//                                             <p>At Grocery Store, we bring you the finest selection of fresh produce, pantry essentials, and everyday favorites.</p>
//                                             <ul className="e-baner-ul">
//                                                 <li>
//                                                     <div className="price-box">
...
//                                     <div className="col-lg-6">
//                                         <div className="bnr-img">
//                                        <img src="/images/g-new-baner.png" alt=""/>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
...
//                         <a href="product_category_sidebar.html"><img src="/images/33.jpg" alt="image" className="img-fluid"/></a>
//                     </div>
//                 </div>
...
const Banner = () => {
  ...
  const items = [
    ...
    { img: "/images/05.png", text: "Fruits" },
    { img: "/images/06.png", text: "Carrot" },
    { img: "/images/07.png", text: "Cabbage" },
    { img: "/images/08.png", text: "Cucumber" },
    { img: "/images/09.png", text: "Carrot" },
    { img: "/images/10.png", text: "Dry Foods" },
    { img: "/images/11.png", text: "Chili/Pepper" },
